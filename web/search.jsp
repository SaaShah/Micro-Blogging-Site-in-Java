...
<span><p><form action="post.jsp" method="POST"><input type="text" name="thread" id="thread" style="width: 300px; height: 30; " />
        <input type="submit" value="POST" style="width: 100px; height: 30; "></form></p></span>
</header>
    <%
try{
    String searchit=request.getParameter("search");
...
ResultSet rsd=sd.executeQuery("select * from thread WHERE thread LIKE '%"
 + searchit
 + "%';");
