<%@page language="java" import="java.sql.*" import="java.util.*" import="java.io.*" session="true"%>
...
function notnullp()
{
   ...
   if( document.myForm3.thread.value == "" )
 
   {
     document.myForm3.thread.focus() ;
     return false;
   }
   return( true );
}
...
<h2>Search</h2>
<form name="myForm1" onsubmit="return validate();" action="search.jsp" method="POST">
<ul>
<li><input type="text" name="search" id="search" style="width: 100px;" ></li>
...
<span><p><form name="myForm3" onsubmit="return notnullp();" action="post.jsp" method="POST"><input type="text" name="thread" id="thread" style="width: 300px; height: 30; " />
...
<ul>
    ...
    <li><a href="profile.jsp">Profile</a></i>
